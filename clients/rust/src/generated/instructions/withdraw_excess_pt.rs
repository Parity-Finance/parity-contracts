...
impl WithdrawExcessPt {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = WithdrawExcessPtInstructionData::new().try_to_vec().unwrap();
...
pub struct WithdrawExcessPtInstructionData {
    discriminator: [u8; 8],
}

impl WithdrawExcessPtInstructionData {
    pub fn new() -> Self {
        Self {
...
/// Instruction builder for `WithdrawExcessPt`.
///
/// ### Accounts:
///
///   0. `[writable]` global_config
///   1. `[writable]` base_mint
///   2. `[writable]` admin_base_mint_ata
///   3. `[writable]` vault
///   4. `[signer]` admin
...
#[derive(Default)]
pub struct WithdrawExcessPtBuilder {
...
/// `withdraw_excess_pt` CPI accounts.
pub struct WithdrawExcessPtCpiAccounts<'a, 'b> {
...
/// `withdraw_excess_pt` CPI instruction.
pub struct WithdrawExcessPtCpi<'a, 'b> {
...
impl<'a, 'b> WithdrawExcessPtCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: WithdrawExcessPtCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `WithdrawExcessPt` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` global_config
...
///   6. `[]` token_program
///   7. `[]` associated_token_program
pub struct WithdrawExcessPtCpiBuilder<'a, 'b> {
    instruction: Box<WithdrawExcessPtCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> WithdrawExcessPtCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(WithdrawExcessPtCpiBuilderInstruction {
            __program: program,
            global_config: None,
            base_mint: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = WithdrawExcessPtCpi {
...
struct WithdrawExcessPtCpiBuilderInstruction<'a, 'b> {
