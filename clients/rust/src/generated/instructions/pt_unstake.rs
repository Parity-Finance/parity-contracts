...
impl PtUnstake {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = PtUnstakeInstructionData::new().try_to_vec().unwrap();
...
pub struct PtUnstakeInstructionData {
    discriminator: [u8; 8],
}

impl PtUnstakeInstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct PtUnstakeInstructionArgs {
    pub quantity: u64,
}

/// Instruction builder for `PtUnstake`.
///
/// ### Accounts:
///
...
impl PtUnstakeBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = PtUnstakeInstructionArgs {
...
/// `pt_unstake` CPI accounts.
pub struct PtUnstakeCpiAccounts<'a, 'b> {
...
/// `pt_unstake` CPI instruction.
pub struct PtUnstakeCpi<'a, 'b> {
    ...
    pub __args: PtUnstakeInstructionArgs,
}

impl<'a, 'b> PtUnstakeCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: PtUnstakeCpiAccounts<'a, 'b>,
        args: PtUnstakeInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `PtUnstake` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` global_config
...
///   7. `[]` token_program
///   8. `[]` associated_token_program
pub struct PtUnstakeCpiBuilder<'a, 'b> {
    instruction: Box<PtUnstakeCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> PtUnstakeCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(PtUnstakeCpiBuilderInstruction {
            __program: program,
            global_config: None,
            user_stake: None,
            base_mint: None,
...
struct PtUnstakeCpiBuilderInstruction<'a, 'b> {
