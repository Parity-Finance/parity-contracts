...
/// Accounts.
pub struct UpdateXmintMetadata {
...
impl UpdateXmintMetadata {
    pub fn instruction(
        &self,
        args: UpdateXmintMetadataInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = UpdateXmintMetadataInstructionData::new()
            .try_to_vec()
            .unwrap();
...
pub struct UpdateXmintMetadataInstructionData {
    discriminator: [u8; 8],
}

impl UpdateXmintMetadataInstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct UpdateXmintMetadataInstructionArgs {
    pub name: String,
    pub symbol: String,
    pub uri: String,
}

/// Instruction builder for `UpdateXmintMetadata`.
///
/// ### Accounts:
///
...
#[derive(Default)]
pub struct UpdateXmintMetadataBuilder {
...
impl UpdateXmintMetadataBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = UpdateXmintMetadataInstructionArgs {
...
/// `update_xmint_metadata` CPI accounts.
pub struct UpdateXmintMetadataCpiAccounts<'a, 'b> {
...
/// `update_xmint_metadata` CPI instruction.
pub struct UpdateXmintMetadataCpi<'a, 'b> {
    ...
    pub __args: UpdateXmintMetadataInstructionArgs,
}

impl<'a, 'b> UpdateXmintMetadataCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: UpdateXmintMetadataCpiAccounts<'a, 'b>,
        args: UpdateXmintMetadataInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `UpdateXmintMetadata` via CPI.
///
/// ### Accounts:
///
///   0. `[writable]` pool_manager
...
///   5. `[]` system_program
pub struct UpdateXmintMetadataCpiBuilder<'a, 'b> {
    instruction: Box<UpdateXmintMetadataCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> UpdateXmintMetadataCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(UpdateXmintMetadataCpiBuilderInstruction {
            __program: program,
            pool_manager: None,
            owner: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = UpdateXmintMetadataCpi {
...
struct UpdateXmintMetadataCpiBuilderInstruction<'a, 'b> {
